...
CREATE TABLE `tbalunos` (
  ...
  `tbTurma_turma` varchar(5) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_tbAlunos_tbTurma1_idx` (`tbTurma_turma`),
  CONSTRAINT `fk_tbAlunos_tbTurma1` FOREIGN KEY (`tbTurma_turma`) REFERENCES `tbturma` (`turma`)

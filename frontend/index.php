...
<body style="display: none;" class="grid grid-cols-12 gap-x-1">
    ...
    <section id="main" class="col-span-8 sm:col-span-10 overflow-x-auto">
        <div role="status" id="loading" style="display:none" class="modal fixed inset-0 flex items-center justify-center z-50">
                <svg aria-hidden="true" class="w-12 h-12 text-gray-200 animate-spin fill-green-900" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">

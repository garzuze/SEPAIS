...
function loadCadastrarAluno() {
    ...
    $('#main').prepend(`
                <div>
                    <form id="form_valida" class="mt-4 mx-auto grid grid-cols-4 w-3/4 gap-2">
                    <h2 class="mb-4 text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl col-span-4">Cadastrar aluno</h2>
                        ...
                        <div class="col-span-1">
                            ...
                            <select id="select-turmas" required name="turma" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                            <option disabled value="regular" selected="">Selecionar turma</option>
                            </select>
                        </div>
                        <div class="justify-self-end col-span-4">
                            <p class="text-green-600 cursor-pointer hover:underline"><small>Adicionar mais um aluno</small></p>
                        </div>
                `)
    $('#form_valida').append(`

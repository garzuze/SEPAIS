                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#">
                            <div>
                                    ...
                                    <select required name="funcao" id="category" class="select-funcao bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                            ...
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                Já tem uma conta? <a href="login.php" class="font-medium text-green-700 focus:underline hover:underline">Fazer login</a>
                            </p>
                        </form>
                    </div>
                </div>
